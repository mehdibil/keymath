default:
	...
	gcc -O3 -c gmpecc.c -o gmpecc.o  # Uncomment this line
	...
	gcc -O3 -o calculatefromkey calculatefromkey.c gmpecc.o util.o base58.o sha256.o rmd160.o -lgmp	`libgcrypt-config --cflags --libs`
	...
	gcc -O3 -o sharedsecret sharedsecret.c gmpecc.o util.o sha256.o base58.o rmd160.o -lgmp `libgcrypt-config --cflags --libs`
	gcc -o addr2rmd addr2rmd.c util.o base58.o
	gcc -o test_functions test_functions.c util.o
	gcc -O3 -o verifymsg verifymsg.c gmpecc.o util.o sha256.o base58.o rmd160.o -lgmp
	#rm *.o
